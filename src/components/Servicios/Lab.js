...
const mapStateToProps = ({ query, bill }) => {
 const { text, Patient, Laboratory } = query;
 const { loading, error, succes } = bill;
 console.log(query);
 return { text, Patient, Laboratory, loading, error, succes };
};

export default connect(
  mapStateToProps,
  { queryFunc, cleanFunc, addBill, clearBill })(Lab);
