...
class AgregarProducto extends Component {
      ...
      return (
        ...
        <CardSection>
          ...
          selectTextOnFocus
            ...
            value={this.state.producto.descuentoProveedor}
            onEndEditing={() => this.actualizarCosto()}
          />
  ...
  renderButton() {
    if (this.state.loading) {
      ...
      return (
    <Button onPress={() => this.agregarProducto()}>
    Agregar producto
    </Button>
  );
  }
    ...
    render() {
      ...
      return (
        ...
        <CardSection>
          ...
          onChangeText={value => this.setState({
            producto: update(this.state.producto, { tipo: { $set: value } })
          })}
